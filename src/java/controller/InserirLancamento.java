...
@WebServlet(name = "InserirLancamento", urlPatterns = {"/InserirLancamento"})
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(session!=null){//checa login
            if(session.getAttribute("usuario")!=null){
                ...
                Lancamento aux=new Lancamento(0,(String)request.getParameter("nome_conta"),(String)request.getParameter("categoria"),valor,(String)request.getParameter("operacao"),(String)request.getParameter("data"),(String)request.getParameter("descricao"));
                DAO.insere(aux);
