        ...
        if(session!=null){//checa login
            if(session.getAttribute("usuario")!=null){
                ...
                if(usuario.getSuspenso().equals("A")){//admin
                    ...
                    Usuario aux=new Usuario(0,(String)request.getParameter("nome"),(String)request.getParameter("cpf"),(String)request.getParameter("senha"),(String)request.getParameter("suspenso"));
                    DAO.insere(aux);
