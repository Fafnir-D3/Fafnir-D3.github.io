...
public class Usuario {
    ...
    public boolean isSuspenso() {return (suspenso.equals("S"));}
    ...
    public String getSuspenso() {return suspenso;}
    public void setSuspenso(String suspenso) {this.suspenso = suspenso;}
