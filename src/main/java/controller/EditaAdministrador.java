...
@WebServlet(name = "EditaAdministrador", urlPatterns = {"/EditaAdministrador"})
        ...
        if(session!=null){//checa login
            if(session.getAttribute("usuario")!=null){
                ...
                if(usuario.getSuspenso().equals("A")){//admin
                    ...
                    Usuario aux=new Usuario(id,(String)request.getParameter("nome"),(String)request.getParameter("cpf"),(String)request.getParameter("senha"),"A");
                    DAO.edita(aux,id);
