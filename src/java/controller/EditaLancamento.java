...
@WebServlet(name = "EditaLancamento", urlPatterns = {"/EditaLancamento"})
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(session!=null){//checa login
            if(session.getAttribute("usuario")!=null){
                    ...
                    Lancamento lancamento=new Lancamento(id,(String)request.getParameter("nome_conta"),(String)request.getParameter("categoria"),valor,(String)request.getParameter("operacao"),(String)request.getParameter("data"),(String)request.getParameter("descricao"));
