...
<%/*
    Pagina auxiliar para editar administradores, ela recebe todos os parametros para 
...
<html>
    ...
    <body>
      ...
      <div class="bg-image" style=" background-image: url('img/background.jpg');  height: 100vh; overflow: auto;">
        ...
        <form method="POST" action="EditaAdministrador">
            ...
            <div class="form-group">
                ...
                <input type="hidden" class="form-control" required name="suspenso" id="suspensoregistro" value="<%="A"%>" >
            </div>
            <div class="form-group">
